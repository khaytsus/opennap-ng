...
$Id: redirect.c 434 2006-09-03 17:48:47Z reech $ */
...
HANDLER(redirect_client)
{
    ...
    notify_mods(CHANGELOG_MODE, "%s redirected %s to %s:%s", sendernick, av[0], av[1], av[2]);
...
HANDLER(cycle_client)
{
    ...
    notify_mods(CHANGELOG_MODE, "%s cycled %s to %s", sendernick, sendernick, nick, server);
